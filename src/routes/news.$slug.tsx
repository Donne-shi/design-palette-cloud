  ...
  return (
    <SiteShell>
      <div className="container-prose py-24 text-center">
        ...
        <h1 className="serif text-3xl">{t("文章未找到","Article not found")}</h1>
        <Link to="/news" className="inline-block mt-6 bg-accent text-accent-foreground px-4 py-2 text-sm uppercase tracking-wider">{t("返回新闻","Back to News")</Link>
      </div>
    </SiteShell>
  );
}
